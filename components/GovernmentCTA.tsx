...
export function GovernmentCTA() {
  return (
    <section className="border border-line bg-white p-8 shadow-[0_8px_24px_rgba(12,30,56,0.04)] md:p-10">
      ...
      <p className="mt-3 max-w-2xl text-muted">
        ...
        general merchandise. Federal registration details are published only when
        verified.
      </p>
      <div className="mt-6">
        <Button href="/government#inquiry">Government Purchasing Inquiry</Button>
      </div>
    </section>
  );
}
