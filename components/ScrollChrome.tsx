...
export function BackToTop() {
  ...
  return (
    <button
      ...
      className="fixed right-8 bottom-8 z-50 flex h-11 w-11 items-center justify-center rounded-full bg-indigo text-white shadow-lg transition-all duration-300"
      style={{
        opacity: vis ? 1 : 0,
